  ...
  <div>
    <div class="right-auth">
      ...
      <form class="my-form-group">
        <div class="my-input"
        :class="{ 'my-input-invalid' : $v.pw.password1.$error}">
          <i class="fas fa-lock"></i>
          <input :type="typeField" placeholder="Enter your password"
          v-model.trim="$v.pw.password1.$model"/>
        ...
        <div class="my-input"
        :class="{ 'my-input-invalid' : $v.pw.password2.$error}">
          <i class="fas fa-lock"></i>
          <input :type="typeField" placeholder="Enter your password"
          v-model.trim="$v.pw.password2.$model"/>
          <i :class=" typeField == 'password' ? 'fas fa-eye iconz' : 'fas fa-eye-slash iconz'"
          style="cursor: pointer; color: rgba(58, 61, 66, 0.6);" @click="showPw"></i>
        </div>
        <button type="submit" id="signin"
        :disabled="$v.pw.$invalid"
        :class="{ 'btnCondition' : $v.pw.$invalid}"
